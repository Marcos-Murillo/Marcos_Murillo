  ...
  return (
    ...
    >
      ...
      {children && (
        <div
          className={cn(
            "relative h-40 place-content-center overflow-hidden rounded-[15px] border-white bg-white/70 dark:border-neutral-950 dark:bg-black/50 flex items-center justify-center",
            className,
          )}
        >
          {children}
